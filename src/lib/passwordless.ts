...
type VerificationAdapterCtx = {
        context: {
                internalAdapter: {
                        findVerificationValue: (id: string) => Promise<VerificationRecord | null | undefined>;
                        deleteVerificationByIdentifier: (id: string) => Promise<void>;
                        updateVerificationByIdentifier: (id: string, data: { value: string }) => Promise<unknown>;
                };
        };
};
                        ...
                        verify: createAuthEndpoint(
                                ...
                                async (ctx) => {
                                        ...
                                        let user = await ctx.context.internalAdapter
                                                ...
                                                .then((res: { user: BetterAuthUser } | null | undefined) => res?.user);
